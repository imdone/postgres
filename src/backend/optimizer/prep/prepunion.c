					   ...
					   double *pNumGroups)
{
	if (IsA(setOp, RangeTblRef))
	{
		...
		*pTargetList = tlist;
		 ...
		 *
		 * XXX you don't really want to know about this: we do the estimation id:320 gh:321
	...
	else if (IsA(setOp, SetOperationStmt))
	{
		 ...
		 * output columns.
		 *
		 * XXX you don't really want to know about this: setrefs.c will apply id:257 gh:258
				  ...
				  PlannerInfo *root)
{
	...
	/*
	 * XXX for the moment, take the number of distinct groups as equal to the id:240 gh:241
					...
					const char *construct)
{
	...
	/* XXX cost_sort doesn't actually look at pathkeys, so just pass NIL  id:386 gh:387*/
					 ...
					 List *refnames_tlist)
{
	...
	forthree(ctlc, colTypes, cclc, colCollations, itlc, input_tlist)
	{
		 ...
		 * necessary.
		 *
		 * HACK: constants in the input's targetlist are copied up as-is id:297 gh:298
							   ...
							   adjust_appendrel_attrs_context *context)
{
	...
	/*
	 * NOTE: we do not need to recurse into sublinks, because they should id:321 gh:322
